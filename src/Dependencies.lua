...
['locke-and-key'] = love.graphics.newImage('graphics/keys_and_locks.png'),
...
['locke-and-key'] = GenerateQuads(gTextures['locke-and-key'], 16, 16),
...
--this code must be in another file
--we draw our floors
